...
flock /tmp python3 -m pyperformance run --python ./python.nobolt --rigorous --manifest ~/macrobenchmarks/benchmarks/WEB_MANIFEST -o nobolt_macrobenchmarks.json -b djangocms,flaskblogging
flock /tmp python3 -m pyperformance run --python ./python --rigorous --manifest ~/macrobenchmarks/benchmarks/WEB_MANIFEST -o bolt_macrobenchmarks.json -b djangocms,flaskblogging
