...
csv_reader(PyObject *module, PyObject *args, PyObject *keyword_args)
{
    ...
    if (!PyArg_UnpackTuple2(args, "", 1, 2, &iterator, &dialect)) {
        Py_DECREF(self);
        return NULL;
    }
...
csv_writer(PyObject *module, PyObject *args, PyObject *keyword_args)
{
    ...
    if (!PyArg_UnpackTuple2(args, "", 1, 2, &output_file, &dialect)) {
        Py_DECREF(self);
        return NULL;
    }
...
csv_register_dialect(PyObject *module, PyObject *args, PyObject *kwargs)
{
    ...
    if (!PyArg_UnpackTuple2(args, "", 1, 2, &name_obj, &dialect_obj))
        return NULL;
...
csv_exec(PyObject *module) {
    ...
    PyObject *bases = PyTuple_Pack1(PyExc_Exception);
    if (bases == NULL) {
        return -1;
    }
